export declare const openNewTab:(url?: string, incognito?: boolean, newWindow?: boolean, focus?: boolean) => void;
export declare const closeTabs:(callback:(tab: chrome.tabs.Tab) => boolean) => void;
export declare const muteTabs:(callback:(tab: chrome.tabs.Tab) => boolean) => void;
export declare const unmuteTabs:(callback:(tab: chrome.tabs.Tab) => boolean) => void;
